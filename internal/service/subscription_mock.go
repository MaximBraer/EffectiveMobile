...
// Source: D:\Projects\GO\EffectiveMobile\internal\service\subscription.go
//
// Generated by this command:
//
//	mockgen -source=D:\Projects\GO\EffectiveMobile\internal\service\subscription.go -destination=D:\Projects\GO\EffectiveMobile\internal\service\subscription_mock.go -package=service
//
...
func (m *MockSubscriptionRepository) CreateSubscription(ctx context.Context, p repository.CreateSubscriptionParams, log *slog.Logger) (int64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateSubscription", ctx, p, log)
	ret0, _ := ret[0].(int64)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockSubscriptionRepositoryMockRecorder) CreateSubscription(ctx, p, log any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateSubscription", reflect.TypeOf((*MockSubscriptionRepository)(nil).CreateSubscription), ctx, p, log)
}
